      ...
      <div className='backsty vh '>
        ...
        <div className='d-flex justify-content-center '>
          <Carousel className='caros'>
            <Carousel.Item className='car1 text-center'>
              <h3>"EducationHub has set many careers!"</h3>
              <p>--Madhukar Bhaktha--</p>
              <br></br><br></br>
            </Carousel.Item>
        ...
        <div className='row container-fluid'>
          ...
          <div className='container-fluid col-6 px-5 pt-5'>
            <h2 className='intro1'>Welcome to, EducationHub!</h2><br></br>
        ...
        <footer>
        <h3 className='text-center text-secondary bg-dark foot'>Developed by EducationHub Team of Institutions PVT. LTD. </h3>
        </footer>
      </div>
    </div>
  );
